...
export function HttpRequestNode({ id, data }: { id: string, data: any }) {
  ...
  return (
    <div className="w-[240px] rounded-xl border border-cyan-200 dark:border-cyan-900/50 bg-card text-card-foreground shadow-sm transition-all hover:shadow-md group">
      <Handle type="target" position={Position.Left} className="w-5 h-5 border-2 border-cyan-500 bg-popover" />
