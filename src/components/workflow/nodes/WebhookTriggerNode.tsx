...
export function WebhookTriggerNode({ id, data }: { id: string, data: any }) {
  ...
  return (
    <div className="w-[240px] rounded-xl border border-lime-200 dark:border-lime-900/50 bg-card text-card-foreground shadow-sm transition-all hover:shadow-md group">
